...
当前普通严格警告与 UBSan 构建均为 30 组通过、0 失败。
...
c++ -std=c++17 -Wall -Wextra -Wpedantic -Werror -g -O1 \
  ...
  src/optimizer/column_pruning.cpp src/optimizer/optimizer.cpp \
